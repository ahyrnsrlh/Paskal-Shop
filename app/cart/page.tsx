      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center bg-white rounded-xl shadow-lg p-12">
            ...
            <h1 className="text-3xl font-bold mb-4 text-gray-900">Memuat Keranjang...</h1>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center bg-white rounded-xl shadow-lg p-12">
            ...
            <h1 className="text-3xl font-bold mb-4 text-gray-900">Keranjang Kosong</h1>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-8 text-gray-900">Keranjang Belanja</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div key={item.id} className="bg-white rounded-xl shadow-lg p-6">
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button variant="outline" size="icon" onClick={() => updateQuantity(item.id, item.quantity - 1)} className="border-gray-200 hover:bg-gray-50 rounded-lg">
          ...
          <div>
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Ringkasan Pesanan</h2>
              <div className="space-y-4">
                ...
                <Button asChild className="w-full bg-green-600 hover:bg-green-700 rounded-lg" size="lg">
