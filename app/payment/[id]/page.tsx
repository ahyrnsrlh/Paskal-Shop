  ...
  const handleUploadPaymentProof = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          title: "Berhasil!",
          description: "Bukti pembayaran berhasil diupload. Pesanan akan diverifikasi dalam 1x24 jam.",
        })
  ...
  const getPaymentStatusBadge = (status: string) => {
    switch (status) {
      case "WAITING_PAYMENT":
        return <Badge variant="outline" className="bg-yellow-50 text-yellow-700 border-yellow-200"><Clock className="w-3 h-3 mr-1" />Menunggu Pembayaran</Badge>
      case "PAYMENT_UPLOADED":
        return <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200"><Upload className="w-3 h-3 mr-1" />Bukti Diupload</Badge>
      case "PAYMENT_CONFIRMED":
        return <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200"><CheckCircle className="w-3 h-3 mr-1" />Pembayaran Dikonfirmasi</Badge>
      case "PAYMENT_REJECTED":
        return <Badge variant="outline" className="bg-red-50 text-red-700 border-red-200"><AlertCircle className="w-3 h-3 mr-1" />Pembayaran Ditolak</Badge>
      default:
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Pesanan dengan ID tersebut tidak ditemukan</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">Transfer ke Rekening Berikut:</h4>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      <span>Jumlah:</span>
                      <div className="flex items-center gap-2">
                        <span className="font-mono font-bold text-lg">{formatPrice(order.totalAmount)}</span>
                        <Button
                          variant="ghost"
                          size="sm"
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">Transfer ke E-Wallet Berikut:</h4>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span>Platform:</span>
                      <div className="flex items-center gap-2">
          ...
          {order.paymentMethod === "cod" && (
            <Card>
              <CardHeader>
                <CardTitle>Instruksi Pembayaran - Bayar di Tempat (COD)</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">Pembayaran Cash on Delivery</h4>
                  <div className="space-y-2">
                    <p>Pembayaran akan dilakukan saat barang diterima.</p>
                    <p className="font-semibold">Total yang harus dibayar: {formatPrice(order.totalAmount)}</p>
                  </div>
                </div>
                <div className="text-sm text-gray-600 space-y-1">
          ...
          {(order.paymentMethod === "transfer" || order.paymentMethod === "ewallet") && 
                ...
                {order.paymentProof ? (
                  <div className="bg-green-50 p-4 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-green-800">Bukti pembayaran sudah diupload</span>
                    </div>
                    <p className="text-sm text-green-700">Bukti pembayaran sedang dalam proses verifikasi oleh admin.</p>
                    {order.paymentNotes && (
                      <div className="mt-2">
                        <p className="text-sm font-medium">Catatan dari admin:</p>
                        <p className="text-sm text-gray-600">{order.paymentNotes}</p>
                      </div>
                    )}
                  </div>
                ) : (
            ...
            <Card>
              ...
              <CardContent>
                <div className="bg-green-50 p-4 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    <CheckCircle className="h-5 w-5 text-green-600" />
                    <span className="font-semibold text-green-800">Pembayaran Dikonfirmasi</span>
                  </div>
                  <p className="text-sm text-green-700 mb-4">
                    Pembayaran Anda telah dikonfirmasi. Anda dapat mengunduh invoice sebagai bukti pembayaran.
                  </p>
                  <Button
