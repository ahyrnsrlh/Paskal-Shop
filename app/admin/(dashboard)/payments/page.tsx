    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description: `Pembayaran untuk pesanan #${orderId} telah ${
            newStatus === "PAYMENT_CONFIRMED" ? "dikonfirmasi" : "ditolak"
          }`,
        });
        fetchOrders();
            ...
            <div className="flex-1">
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="PAYMENT_UPLOADED">
                    Bukti Diupload
                  </SelectItem>
                  ...
                  <div className="flex items-center gap-2">
                    <Dialog>
                      ...
                      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        <DialogHeader>
                          <DialogTitle>
                            Detail Pembayaran #{selectedOrder?.id}
                          </DialogTitle>
                          <DialogDescription>
